...
const FACTORY_PRESETS: Omit<UnifiedPreset, 'id' | 'lastModified' | 'energyLevel'>[] = [
  { name: 'Olympus Domain', type: 'Multi-Realm', author: 'VST GOD', rating: 5, fav: true, tags: ['Multi-Realm', 'Sacred', 'Ancient'], source: 'vault', state: null },
  { name: "Zeus' Thunder", type: 'Bass', author: 'VST GOD', rating: 5, fav: true, tags: ['Bass', 'Sacred', 'Power'], source: 'vault', state: null },
  { name: 'Godspeed', type: 'Lead', author: 'VST GOD', rating: 5, fav: true, tags: ['Lead', 'Sacred', 'Fast'], source: 'vault', state: null },
  { name: 'Heavenly Gates', type: 'Pad', author: 'VST GOD', rating: 5, fav: false, tags: ['Pad', 'Sacred', 'Ethereal'], source: 'vault', state: null },
  { name: 'Divine Touch', type: 'Pluck', author: 'VST GOD', rating: 5, fav: false, tags: ['Pluck', 'Sacred', 'Delicate'], source: 'vault', state: null },
  { name: 'Eternal Choir', type: 'Pad', author: 'VST GOD', rating: 4, fav: false, tags: ['Pad', 'Sacred', 'Choir'], source: 'vault', state: null },
  { name: 'Titan Rise', type: 'Arp', author: 'VST GOD', rating: 4, fav: false, tags: ['Arp', 'Sacred', 'Rising'], source: 'vault', state: null },
  { name: 'Celestial Keys', type: 'Keys', author: 'VST GOD', rating: 5, fav: false, tags: ['Keys', 'Sacred', 'Bright'], source: 'vault', state: null },
  { name: 'Wrath of Zeus', type: 'FX', author: 'VST GOD', rating: 4, fav: false, tags: ['FX', 'Sacred', 'Thunder'], source: 'vault', state: null },
  { name: 'Mount Olympus', type: 'Textures', author: 'VST GOD', rating: 5, fav: false, tags: ['Textures', 'Sacred', 'Epic'], source: 'vault', state: null },
  { name: 'Golden Era', type: 'Pad', author: 'VST GOD', rating: 4, fav: false, tags: ['Pad', 'Sacred', 'Warm'], source: 'vault', state: null },
  { name: 'Lightning Strike', type: 'Lead', author: 'VST GOD', rating: 5, fav: false, tags: ['Lead', 'Sacred', 'Aggressive'], source: 'vault', state: null },
  { name: 'Sacred Bass', type: 'Bass', author: 'VST GOD', rating: 4, fav: false, tags: ['Bass', 'Sacred', 'Deep'], source: 'vault', state: null },
  { name: 'Astral Drift', type: 'Pad', author: 'VST GOD', rating: 3, fav: false, tags: ['Pad', 'Sacred', 'Ambient'], source: 'vault', state: null },
  { name: 'Hades Pluck', type: 'Pluck', author: 'VST GOD', rating: 4, fav: false, tags: ['Pluck', 'Sacred', 'Dark'], source: 'vault', state: null },
];

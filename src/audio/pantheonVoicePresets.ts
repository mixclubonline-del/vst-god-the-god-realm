...
export const GOD_VOICE_PRESETS: Record<string, GodVoicePreset> = {
  olympus: {
    ...
    bodyType: 'sine', bodyGain: 0.3, detuneCents: 10,
    ...
    subOscGain: 0.15, vibratoRate: 3.5, vibratoDepth: 5,
  },
  hades: {
    id: 'hades',
  ...
  athena: {
    ...
    bodyType: 'sine', bodyGain: 0.4, detuneCents: 12,
    ...
    satDrive: 1.6, satMix: 0.25,
    subOscGain: 0.2, vibratoRate: 4.0, vibratoDepth: 6,
  },
  poseidon: {
    id: 'poseidon',
    carrier: 'triangle', modRatio: 0.5, modIndex: 1.5,
    bodyType: 'sine', bodyGain: 0.35, detuneCents: 16,
    filterType: 'lowpass', filterFreq: 1400, filterQ: 0.6,
    attack: 0.22, decay: 1.0, sustain: 0.7, release: 2.4,
    reverbDecay: 4.0, reverbMix: 0.45,
    chorusRate: 0.3, chorusDepth: 0.006, chorusMix: 0.4,
    delayTime: 0.666, delayFeedback: 0.5, delayMix: 0.3,
    satDrive: 1.0, satMix: 0.1,
    subOscGain: 0.3, vibratoRate: 2.2, vibratoDepth: 10,
  },
  titan: {
    id: 'titan',
  ...
  chronos: {
    ...
    bodyType: 'triangle', bodyGain: 0.2, detuneCents: 25,
    filterType: 'lowpass', filterFreq: 1100, filterQ: 0.7,
    attack: 0.20, decay: 0.3, sustain: 0.5, release: 2.8,
    ...
    subOscGain: 0.15, vibratoRate: 2.8, vibratoDepth: 12,
  },
};
